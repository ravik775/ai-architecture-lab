...
def style_guide():
    logging.info("RESOURCE CALLED: docs://style-guide")
...
def writing_rules():
    logging.info("RESOURCE CALLED: docs://writing-rules")
...
@mcp.prompt(
    name="polish_text_prompt",
    title="Polish Text Prompt",
    description="Generate a professional text-polishing prompt.",
)
def polish_text_prompt(raw_text: str):
    prompt_text = f"""
You are a professional editor.

Correct grammar, spelling, and punctuation.
Improve clarity, professionalism, and consistency.
...
def polish_text(raw_text: str) -> PolishedText:
    ...
    """
    logging.info("TOOL CALLED: polish_text")
